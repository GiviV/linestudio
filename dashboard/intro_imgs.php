    ...
    <main>
        ...
        <div class="dashboard-content">
            <div class="list-title">
                <h2>Work Images</h2>
                <a href="add_intro.php"><button class="add">Add image</button></a>
            </div>
    ...
    foreach ($works as $item) {
        echo '<tr data-id="' . $item['id'] . '">
                ...
                <td>  <img class="grid-item" src="../../imgs/works/' . $item['image'] . '" alt="Image"></td>
                 ...
                 <td>
                      <a href="home_vendor/delete.php?id='.$item['id'].'"><button class="delete">delete</button></a>
                     </td>
              </tr>';
    }
    ?>
...
$(document).ready(function() {
    $("#sortable").sortable({
        update: function(event, ui) {
            ...
            $.post("update_order_main.php", { newOrder: newOrder }, function(response) {
